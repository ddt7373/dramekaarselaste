-- =============================================================================
-- Redaksie: RLS-fix vir artikel verwyder (werk sonder Supabase Auth)
-- =============================================================================
-- RLS gebruik auth.uid() wat by NHKA-aanmelding nie gestel is nie. Die RPC stel
-- 'n sessie-variabele (slegs vir hierdie transaksie); die DELETE-beleid laat
-- verwydering toe as daardie variabele 'n geldige admin-gebruiker is.
-- =============================================================================
...
COMMENT ON FUNCTION public.delete_artikel_indiening(uuid, uuid) IS 'Verwyder artikel-indiening; stel app.current_gebruiker_id sodat RLS die DELETE toelaat.';
